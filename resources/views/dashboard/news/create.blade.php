...
@section('container')
    <div class="container py-4 py-xl-5" style="font-family: ABeeZee, sans-serif;">
        ...
        <div class="row mb-5">
            ...
            <form class="row g-2 needs-validation" method="post" action="/dashboard/news" novalidate>
                @csrf
                <div class="col-md-6 position-relative">
                    ...
                    <input type="text" id="validationCustom01" class="form-control" name="creator"
                        placeholder="Isi Nama Anda" value="Administrator SPI" required>
                ...
                <div class="col-md-6 position-relative">
                    ...
                    <input type="text" id="validationCustom01" class="form-control" name="title"
                        placeholder="Isi Tajuk Berita" required>
                    <div class="invalid-tooltip">
                        Isi Tajuk Berita.
                    </div>
                </div>
                <div class="col-md-12">
                    <label for="validationCustom01" class="form-label">Thumbnail Berita (Masukan 1 link gambar saja.)<span
                            class="text-danger">*</span></label>
                    <input type="url" id="validationCustom01" class="form-control" name="thumbnail"
                        placeholder="Isi Thumbnail Berita" required>
                    <div class="invalid-tooltip">
